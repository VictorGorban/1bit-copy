...
import { ReactContext as GlobalsContext } from '@components/providers/Globals'
...
export default function Component({ }) {
    ...
    function renderFooterMenuItem(menuItem) {
        ...
        let result = null
        result =
            <AnimatedLink href="/" key={menuItem.href} className={`nav-item ${menuItem.href ? pathname.startsWith(menuItem.href) : pathname == menuItem.href && 'active'}`}>
                <li>
                    {menuItem.title}
                </li>
            </AnimatedLink>
