                    ...
                    >
                        ...
                        <div className="bg-white px-40 py-30 border-radius-5">
                            <div className="header d-flex align-items-center justify-content-center mb-10">
                                <h5 className="modal-heading">Подтвердите удаление: {objectName}</h5>
                            </div>
                            <div className="content form w-100 d-flex justify-content-center flex-wrap mt-10">
                                <p className="size-20">Вы уверены, что хотите удалить окончательно этот объект? Восстановить его будет невозможно.</p>
                            </div>

                            <div className="footer d-flex justify-content-center align-items-center mt-30">
                                <button
                                                                        className={`btn style-danger mx-05 py-20 px-20 size-16 weight-500`}
                                    onClick={handleYes}
                                >
                                ...
                                <button
                                                                        className={`btn style-default mx-05 py-20 px-20 size-16 weight-500`}
                                    onClick={handleNo}
                                >
                                    Закрыть это окно
                                </button>
